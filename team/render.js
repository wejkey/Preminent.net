document.addEventListener('DOMContentLoaded', () => {
  ...
  const data = window.TEAM_DATA || { developers: [], support: [] };
  ...
  if (teamRoot) {
    teamRoot.appendChild(renderSection('Developers', data.developers));
    teamRoot.appendChild(renderSection('Support', data.support));
  }
});